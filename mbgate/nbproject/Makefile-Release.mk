...
${OBJECTDIR}/_ext/79b25175/RS485.o: /home/pi/mbgate/RS485.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/79b25175/RS485.o /home/pi/mbgate/RS485.cpp

${OBJECTDIR}/_ext/79b25175/connection_handler.o: /home/pi/mbgate/connection_handler.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/79b25175
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/79b25175/connection_handler.o /home/pi/mbgate/connection_handler.cpp

${OBJECTDIR}/_ext/79b25175/crc.o: /home/pi/mbgate/crc.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/79b25175
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/79b25175/crc.o /home/pi/mbgate/crc.cpp

${OBJECTDIR}/_ext/79b25175/ethernet.o: /home/pi/mbgate/ethernet.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/79b25175
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/79b25175/ethernet.o /home/pi/mbgate/ethernet.cpp

${OBJECTDIR}/_ext/79b25175/serial.o: /home/pi/mbgate/serial.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/79b25175
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/79b25175/serial.o /home/pi/mbgate/serial.cpp
